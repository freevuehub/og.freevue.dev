      ...
      >
        ...
        >
          <div style={
            ...
            <LogoSVG primaey={color || PRIMARY_RGB} secondary={color || SECONDARY_RGB} />
          </div>
        </div>
      </div>
    ),
